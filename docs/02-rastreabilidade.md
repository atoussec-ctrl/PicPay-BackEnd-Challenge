...
| FR-003 | BR-004, BR-005, BR-006 | `UserRepository`, `WalletRepository` | unidade + integração PostgreSQL | T-104, T-301 |
| FR-004 | BR-008, BR-009 | `AuthorizationGateway` | WireMock: approve/deny/timeout/malformed | T-302, T-401 |
