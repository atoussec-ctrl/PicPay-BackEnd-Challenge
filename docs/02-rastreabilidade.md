...
| FR-005 | BR-007, BR-010, BR-014 | `TransferUnitOfWork`, `WalletRepository`, `Wallet` | unidade, integração ACID e concorrência | T-105, T-303, T-304 |
| FR-006 | BR-010, BR-015 | `TransferUnitOfWork`, `TransferRepository`, `LedgerRepository` | rollback por etapa e trigger diferido | T-106, T-303 |
